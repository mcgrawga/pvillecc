...
function DisplayPage()
{
	...
	<p>
		<a href="overallstats.php">Overall Statistics</a><br>
	</p>
	</div>
	<br>
	<?
	...
	else
	{
        ...
        printf("<tr class=\"ScoreHistoryTDHeader\"><td><a href=\"javascript:void();\">Course</td><td class=\"sorttable_nosort\">&nbsp</td><td class=\"sorttable_nosort\">&nbsp</td></tr>");
		while ($row = mysql_fetch_array($result))
		{
			$classname = ($rowCnt % 2) ? 'CourseList2' : 'CourseList1';
			printf("<tr class=\"$classname\">");
			printf("<td>%s</td>",$row["courseandtee"]);
			printf("<td><A HREF=\"trendingstats.php?teeid=%s&num12\">Historical Stats</A>&nbsp&nbsp&nbsp</td>",$row["teeid"],$row["courseandtee"]);
